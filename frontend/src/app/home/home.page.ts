...
@Component({
  ...
  template: `
    ...
    <ion-card [attr.data-testid]="'card_'+box.id" *ngFor="let box of dataService.boxes">
      ...
      <ion-button (click)="openBoxInfo(box.id)">More info</ion-button> <ion-button >Edit</ion-button> <ion-button data-testid="delete_button" (click)="deleteBox(box.id)" color="danger">Delete</ion-button>
